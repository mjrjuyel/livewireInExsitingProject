...
<div class="page-container">
    ...
    @php
    use Carbon\Carbon;
    $preMonth = new DateTime($parseDate);
    $preMonth->modify(' -1 month');

    $nextMonth = new DateTime($parseDate);
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-3">
                            <a href="{{route('superadmin.leaveMonth',$preMonth->format('d-m-Y'))}}" class="btn btn-dark">{{$preMonth->format('F')}}</a>
                        </div>

                        <div class="col-3 offset-1">
                            <strong>Total Leave Request in <span class="text-info"> {{$parseDate->format('F-Y')}}</span></strong>
                        </div>

                        <div class="col-5 text-end">
                            <a href="{{route('superadmin.leaveMonth',$nextMonth->format('d-m-Y'))}}" class="btn btn-dark">{{$nextMonth->format('F')}}</a>
                        </div>
                    </div>
                    <div class="">
