        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-sm-5">
                            <a href="{{route('superadmin.leavetype.add')}}" class="btn btn-primary"><i class="mdi mdi-plus-circle me-2"></i> Add
                                Leave Type</a>
                        </div>
                    </div>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                ...
                                                <li>
                                                    <form action="{{ route('superadmin.leavetype.delete',$role->id) }}" method="post">
                                                        @csrf
                                                        @method('delete')
