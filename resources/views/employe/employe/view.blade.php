                        ...
                        <div class="col-md-8 offset-md-2">
                            ...
                            <div class="card-header bg-dark">
                                <div class="row">
                                    ...
                                    <div class="col-md-2 offset-md-3"><a href="{{route('dashboard.employe.profileSettings',Crypt::encrypt($view->id))}}" class="btn btn-bg btn-primary btn_header"><i class="fa-solid fa-pen-to-square
                                            btn_icon"></i>Edit</a>
                                    </div>
                                </div>
                            </div>
