                ...
                <ul class="side-nav">
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarLeave">
                            <ul class="sub-menu">
                                <li class="side-nav-item">
                                    <a href="{{ url('/dashboard/leave/view/'.Auth::guard('employee')->user()->emp_slug) }}" class="side-nav-link">
                            ...
                            <li class="side-nav-item">
                                <a href="{{ route('dashboard.leave.add') }}" class="side-nav-link">
                                    <span class="menu-text">{{optional($check)->reason}} Apply For</span>
                                </a>
                           </li>
                ...
                <div class="topbar-item nav-user">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <!-- item-->
                            <a href="{{ route('dashboard.employe.passwordChange',Auth::guard('employee')->user()->emp_slug ) }}" class="dropdown-item notify-item">
